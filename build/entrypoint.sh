...
TRACE_ON=1  LOCAL_SIDELOAD_REPO_PATH=/github/workspace dockerfiles/docker-entrypoint.sh all-git-pdf --repo 'sparksam/tiny-book' --book-slug 'book-slug1' --ref main
