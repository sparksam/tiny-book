...
TRACE_ON=1  INPUT_SOURCE_DIR=/github/DATA_DIR/INPUT_SOURCE_DIR LOCAL_SIDELOAD_REPO_PATH=$INPUT_REPO_PATH dockerfiles/docker-entrypoint.sh all-git-pdf $INPUT_REPO_NAME/book-slug1 default main
